...
@interface BTReceiveBeacon () <CBCentralManagerDelegate, CBPeripheralDelegate>
...
@implementation BTReceiveBeacon

+(BTReceiveBeacon*)beacon{
    return [[BTReceiveBeacon alloc]init];
}
